...
public Request = async (
  ...
  async Reactions(IdPost:any,Reaction:string) {
    console.log(IdPost)
    try {
      const cookieString =
      "c_user=100094320435884;xs=2:mmeEgQwO5YYlGA:2:1700065635:-1:-1;fr=0k6f2QTuOtTmH4Y5f.AWVtkwPwn98GkzAPeVaEo5etGqI.BlVPFj.hI.AAA.0.0.BlVPFj.AWVyrRTu7TQ;datr=WvFUZRLDHFBD_b87_HxeZQu9;";
      const headers = {
        authority: 'mbasic.facebook.com',
        accept:
          'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7',
  ...
  async ReactionComment(IdPost:string,Reaction:string) {
    try {
      const cookieString =
      "c_user=100094320435884;xs=2:mmeEgQwO5YYlGA:2:1700065635:-1:-1;fr=0k6f2QTuOtTmH4Y5f.AWVtkwPwn98GkzAPeVaEo5etGqI.BlVPFj.hI.AAA.0.0.BlVPFj.AWVyrRTu7TQ;datr=WvFUZRLDHFBD_b87_HxeZQu9;";
      const headers = {
  ...
  async LikeCommentPost(IdPost:string) {
    try {
      const cookieString =
      "c_user=100094320435884;xs=2:mmeEgQwO5YYlGA:2:1700065635:-1:-1;fr=0k6f2QTuOtTmH4Y5f.AWVtkwPwn98GkzAPeVaEo5etGqI.BlVPFj.hI.AAA.0.0.BlVPFj.AWVyrRTu7TQ;datr=WvFUZRLDHFBD_b87_HxeZQu9;";
      const headers = {
  ...
  async Comment(IdPost:string, content:string) {
    try {
      const cookieString =
      "c_user=100094320435884;xs=2:mmeEgQwO5YYlGA:2:1700065635:-1:-1;fr=0k6f2QTuOtTmH4Y5f.AWVtkwPwn98GkzAPeVaEo5etGqI.BlVPFj.hI.AAA.0.0.BlVPFj.AWVyrRTu7TQ;datr=WvFUZRLDHFBD_b87_HxeZQu9;";
      const headers = {
  ...
  async Share(IdPost:string, content:string) {
    try {
      const cookieString =
      "c_user=100094320435884;xs=2:mmeEgQwO5YYlGA:2:1700065635:-1:-1;fr=0k6f2QTuOtTmH4Y5f.AWVtkwPwn98GkzAPeVaEo5etGqI.BlVPFj.hI.AAA.0.0.BlVPFj.AWVyrRTu7TQ;datr=WvFUZRLDHFBD_b87_HxeZQu9;";
      const headers = {
  ...
  async FollowUser(IdPost:string) {
    try {
      const cookieString =
      "c_user=100094320435884;xs=2:mmeEgQwO5YYlGA:2:1700065635:-1:-1;fr=0k6f2QTuOtTmH4Y5f.AWVtkwPwn98GkzAPeVaEo5etGqI.BlVPFj.hI.AAA.0.0.BlVPFj.AWVyrRTu7TQ;datr=WvFUZRLDHFBD_b87_HxeZQu9;";
      const headers = {
